...
function createGrid(options = {}) {
  ...
  const Grid2 = React12.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React12.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React13.Children.toArray(children2).filter(Boolean);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KA45D5IB.js.map
